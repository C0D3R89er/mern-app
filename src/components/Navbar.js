    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link style={{color:(props.mode==='dark')?'white':'black', textDecoration:'none'}} to="/">Home</Link>
        </li>
        <li className="nav-item">
        <Link className="mx-2" style={{color:(props.mode==='dark')?'white':'black', textDecoration:'none'}} to="/about">About</Link>
        </li>
      </ul>
